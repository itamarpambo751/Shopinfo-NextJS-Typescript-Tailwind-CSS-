...
const ComputerDescription: React.FC<Data>= ({nome,codigo,preco}:Data) => {
	return (
		<div className='pt-2'>
			...
			<h1 className='mt-2 mb-3 text-[1.7rem] leading-9'>{nome}</h1>
			<span className='uppercase text-[var(--border-color)]'>
				cód. {codigo}
			</span>

			<div className='mt-5 mb-3 flex justify-between items-center gap-14'>
				<PublicityCard.Content.Price oldPrice='3.062,08' price={preco} extra/>
